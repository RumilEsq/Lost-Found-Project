document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    if (session && session.user) {
      ...
      if (navbar) {
        if (isAdmin) {
          navbar.innerHTML = `<a href="admin.html">Admin</a> | <a href="items.html">Gallery</a> | <a href="#" id="logoutBtn">Logout</a>`;
        } else {
          navbar.innerHTML = `<a href="items.html">Gallery</a> | <a href="#" id="logoutBtn">Logout</a>`;
        }
      ...
      if (navbar) {
        navbar.innerHTML = `<a href="login.html">Login</a> | <a href="signup.html">Sign Up</a> | <a href="items.html">Gallery</a>`;
      }
    }
...
async function loadStats(supabase) {
  try {
    ...
    if (reports) {
      ...
      const successRate = totalCount > 0 ? Math.round((claimedCount / totalCount) * 100) : 0;
